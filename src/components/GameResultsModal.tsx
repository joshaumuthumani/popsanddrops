...
/** Final standings for one game — top 3 in Gold/Silver/Bronze. Mounted only when open. */
  ...
  return (
    <Modal onClose={onClose} title={game?.name ?? 'Final results'}>
      {!game ? (
        ...
        <p className="text-muted" style={{ fontSize: 13.5 }}>No scores to show for this challenge.</p>
      ) : (
